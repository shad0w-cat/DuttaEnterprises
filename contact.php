...
<body>
    ...
    <div class="head">
        <div class="logo">
            <img src="css/images/logoT.png" alt="logo" height="160px" width="160px">
        ...
        <form class="row g-3" action="#" method="post">
            ...
            <div class="col-md-4">
                ...
                <select class="form-select" id="occupation" name="occupation" required>
                    ...
                    <option value="">Self Employed(Buisness)</option>
                </select>
            </div>
            <div class="col-md-4">
                <label for="income" class="form-label">Occupation name *</label>
                <div class="input-group">
                    <span class="input-group-text" id="inputGroupPrepend2"><i class="fas fa-user-tie"></i></span>
                    <input type="text" class="form-control" id="income" name="job" aria-describedby="inputGroupPrepend2" required>
                </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <label for="occupation" class="form-label">Loan type *</label>
                <select class="form-select" id="loan" name="loan" required>
                    <option selected disabled value="">Select an option</option>
                    <option value="salaried">House loan</option>
                    <option value="self-employed">Car loan</option>
                    <option value="">Buisness loan</option>
                    <option value="">Security loan</option>
                    <option value="">Personal loan</option>
                    <option value="">Education loan</option>
                    <option value="">Property loan</option>
                    <option value="">Real Estate loan</option>
                </select>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4 inactive" id="amtkn">
                <label for="amount" class="form-label">Loan amount taken from other company *</label>
                <div class="input-group">
                    <span class="input-group-text" id="inputGroupPrepend2"><i class="fas fa-rupee-sign"></i></span>
                    <input type="number" class="form-control" id="purchase" name="purchase" aria-describedby="inputGroupPrepend2">
                </div>
            </div>
            <div class="col-md-3">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "INSERT INTO `contact` ( `name`, `father`, `mother`, `email`, `number` , `dob`, `address`, `occupation`, `occupation_name`, `loan`, `income`, `LOC`, `amount`, `purchase`) VALUES ( '$name', '$Fname', '$Mname', '$email', '$contact' , '$dob', '$address', '$occupation', `$job`, `$loan`, '$income', '$LOC', '$amount', `$purchase`)";
...
<script>
    ...
    var box = document.getElementById("amtkn");
    var box2 = document.getElementById("purchase");
